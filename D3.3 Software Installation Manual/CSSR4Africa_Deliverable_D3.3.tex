...
\begin{document}
	...
	\section{Setting up the Development Environment}
	{
		...
		sudo apt-get install ros-noetic-nav-msgs ros-noetic-geometry-msgs
		sudo apt-get install ros-noetic-trajectory-msgs ros-noetic-sensor-msgs
		sudo apt-get install ros-noetic-control-msgs ros-noetic-std-srvs
		sudo apt-get install ros-noetic-cv-bridge ros-noetic-angles
		sudo apt-get install ros-noetic-message-generation 
		sudo apt-get install ros-noetic-message-runtime
		sudo apt-get install ros-noetic-tf2-ros ros-noetic-actionlib-msgs
		...
		\begin{enumerate}
			...
			\begin{enumerate}[leftmargin=0pt,labelsep=0.5em]
				...
				\begin{figure}[!hbpt]
					\centering
					\includegraphics[scale=0.22]{./images/gazebo-screenshot.png}
		...
		\noindent All the twelve software have been uploaded in the \texttt{cssr\_system} and \texttt{unit\_tests} directory: \texttt{animateBehaviour}, \texttt{behaviorController}, \texttt{faceDetection}, \texttt{gestureExecution},\\ \texttt{soundDetection}, \texttt{mapGeneration}, \texttt{robotLocalization}, \texttt{robotNavigation}, \texttt{text\_to\_speech}, \texttt{speech\_event}, \texttt{overtAttention}, and \texttt{personDetection}. \\
		...
		\begin{description}
			...
			\item [Version 1.18]~\\
			Added installation guide for Intel RealSense SDK 2.0. \\
			Muhammed Danso.\\
			29 August 2025.
			
			\item [Version 1.19]~\\
			Added Text to speech installation steps.\\
			Richard Muhirwa.\\
			22 September 2025.
			
			\item [Version 1.2]~\\
			Updated Figure 5 that shows the directory structure of the workspace to include robot localization\\
			Added additional install packages for robot localization and robot navigation to 3.2.2\\
			Ibrahim Jimoh.\\
			27 October 2025.
